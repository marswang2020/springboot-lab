package mars.mybatis.gp.v2.session;

import mars.mybatis.gp.v2.TestMybatis;
import mars.mybatis.gp.v2.annotation.Entity;
import mars.mybatis.gp.v2.annotation.Select;
import mars.mybatis.gp.v2.binding.MapperRegistry;
import mars.mybatis.gp.v2.executor.CachingExecutor;
import mars.mybatis.gp.v2.executor.Executor;
import mars.mybatis.gp.v2.executor.SimpleExecutor;
import mars.mybatis.gp.v2.plugin.Interceptor;
import mars.mybatis.gp.v2.plugin.InterceptorChain;
